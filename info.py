...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('premiumbot1')
else:
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://premiumbot1-58cf73d038f8.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://premiumbot1-58cf73d038f8.herokuapp.com/".format(FQDN, PORT)
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('premiumbot1'))

else:
    ON_HEROKU = False
HAS_SSL=bool(getenv('HAS_SSL',True))
if HAS_SSL:
    URL = "https://premiumbot1-58cf73d038f8.herokuapp.com/".format(FQDN)
else:
    URL = "https://premiumbot1-58cf73d038f8.herokuapp.com/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001919010755'))
